...
# Model Flops: 14.356G
# Model Parameters: 11.167M
# ==============================
_base_ = ['../_base_/default_runtime.py', '../_base_/det_p5_tta.py']
custom_imports = dict(
    imports=["models.backbones.hybrid_net","models.heads.head", "models.necks.neck"], allow_failed_imports=False
)
...
test_evaluator = dict(
    type="mmdet.CocoMetric",
    proposal_nums=(100, 1, 10),
    ann_file=test_data_root + test_ann_file,
    metric="bbox",
    classwise=True,
)
